...
<?php
	...
	$hidden		= ($simpleview == 1)? "hidden" : "text";
	$load = 0;
...
#	print "</form>\n";
	...
	if ($station_code  && ($submit != "Email Metadata")) {
		...
		if(!$simpleview) {
		?>
			<tr><th>statype</th><td><input name="statype" size="2" value="<?php print $statype; ?>" type="<?php print $hidden; ?>"></td></tr> 
			<tr><th>offdate</th><td><input name="offdate" size="10" value="<?php print $offdate; ?>" type="<?php print $hidden; ?>"></td></tr> 
		<?php
		}
		?>
		...
		?>
			...
			<p>For arrays only:</p>
			<table border="1">
			<tr><th>refsta</th><td><input name="refsta" size="5" value="<?php print $refsta; ?>" type="<?php print $hidden; ?>"></td></tr>
			<tr><th>dnorth</th><td><input name="dnorth" size="5" value="<?php print $dnorth; ?>" type="<?php print $hidden; ?>"></td></tr>
			<tr><th>deast</th><td><input name="deast" size="5" value="<?php print $deast; ?>" type="<?php print $hidden; ?>"></td></tr> 
			</table>
		...
		for ($counter = 0; $counter < $numsensors; $counter++) {
			...
			if ($thischan == 'BHZ' ||  $thischan == 'BNZ' || $thischan == 'EHZ' || $thischan == 'ENZ' ||  $thischan == 'HHZ' || $thischan == 'HNZ') {
				...
				if (!$simpleview) {
				?>
					<tr><th>inid</th>   <td> <input name="inid[<?php print $counter; ?>]"    size="4" value="<?php print $inid[$counter]; ?>"      type="<?php print $hidden; ?>"></td></tr>
					<tr><th>calper</th> <td> <input name="calper[<?php print $counter; ?>]"  size="5" value="<?php print $calper[$counter]; ?>"    type="<?php print $hidden; ?>"></td></tr>
					<tr><th>instant</th><td> <input name="instant[<?php print $counter; ?>]" size="5" value="<?php print $instant[$counter]; ?>"   type="<?php print $hidden; ?>"></td></tr>
					<tr><th>endtime</th><td> <input name="endtime[<?php print $counter; ?>]" size="10" value="<?php print $endtime[$counter]; ?>"   type="<?php print $hidden; ?>"></td></tr>
...
$hidden = "hidden";
			...
			if ($thischan == 'BHZ' ||  $thischan == 'BNZ' || $thischan == 'EHZ' || $thischan == 'ENZ' ||  $thischan == 'HHZ' || $thischan == 'HNZ') {
				...
				<td>
				<table border="1">
				<tr><th>chan</th>       <td> <input name="chan[<?php print $counter; ?>]"        size="7" value="<?php print $chan[$counter]; ?>"         type="<?php print $hidden; ?>"></td></tr>
				<tr><th>ondate</th>    <td> <input name="condate[<?php print $counter; ?>]"     size="10" value="<?php print $condate[$counter]; ?>"      type="<?php print $hidden; ?>"></td></tr>
				<tr><th>offdate</th>   <td> <input name="coffdate[<?php print $counter; ?>]"    size="10" value="<?php print $coffdate[$counter]; ?>"     type="<?php print $hidden; ?>"></td></tr> 
				<tr><th>ctype</th>      <td> <input name="ctype[<?php print $counter; ?>]"       size="2" value="<?php print $ctype[$counter]; ?>"        type="<?php print $hidden; ?>"></td></tr>
				<tr><th>edepth</th>     <td> <input name="edepth[<?php print $counter; ?>]"      size="6" value="<?php print $edepth[$counter]; ?>"       type="<?php print $hidden; ?>"></td></tr>
				<tr><th>hang</th>       <td> <input name="hang[<?php print $counter; ?>]"        size="5" value="<?php print $hang[$counter]; ?>"         type="<?php print $hidden; ?>"></td></tr>
				<tr><th>vang</th>       <td> <input name="vang[<?php print $counter; ?>]"        size="5" value="<?php print $vang[$counter]; ?>"         type="<?php print $hidden; ?>"></td></tr>
				<tr><th>descrip</th>    <td> <input name="descrip[<?php print $counter; ?>]"     value="<?php print $descrip[$counter]; ?>"      type="<?php print $hidden; ?>"></td></tr>
				</table>
				<br/>
				</td>
			<?php
